...
_Press `i` to be able to type in text._  
_Copying the existing format for Root, we are giving your user full sudo
rights.<sup>[5](#notes)</sup>_
...
Happy Linuxing!  
_You will have to enter your user password to run a sudo'd command. It seems to
have a "idle" period where you don't need to enter it for a while if you keep
using sudo._
