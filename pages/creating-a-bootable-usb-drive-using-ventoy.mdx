...
7. **Copy ISO Files to USB Drive**
   ...
   - Open File Explorer and navigate to your USB drive. You should see a folder named `ventoy`.
   - Copy and paste the ISO files of the operating systems you want to use into the root directory of the USB drive (outside the `ventoy` folder).
