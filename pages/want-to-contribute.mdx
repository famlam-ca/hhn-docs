...
- **Formatting**: Follow the established [Style Guidelines](https://github.com/famlam-ca/hhn-documentation/blob/main/STYLE_GUIDELINES.mdx) to maintain consistency across the documentation.
