...
- If you are installing TrueNAS scale on proxmox you must first passthrough each disk, or the entire storage controller: [Disk Passthrough on Proxmox](/proxmox/disk-passthrough)
