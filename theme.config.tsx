...
const logo = (
  <svg
    height="25"
    viewBox="0 0 1602 592.8"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="text-primary">
    <path
      d="M500 110 500 510 600 510 600 360 700 360 700 510 800 510 800 110 700 110 700 260 600 260 600 110Z"
      fill="white"
    />
    <path
      d="M900 110 900 510 1000 510 1000 360 1100 360 1100 510 1200 510 1200 110 1100 110 1100 260 1000 260 1000 110Z"
      fill="currentColor"
    />
    <path
      d="M1300 110 1300 510 1400 510 1400 260 1500 510 1600 510 1600 110 1500 110 1500 310 1400 110Z"
      fill="currentColor"
    />

    <path
      d="M244.8 0 224.4 54 3.6 176.4 3.6 198 144 274.8 136.8 294 3.6 219.6 3.6 284.4 118.8 344.4 63.6 486 0 516 0 578.4 36 559.2 25.2 592.8 75.6 592.8 98.4 529.2 319.2 418.8 319.2 393.6 177.6 316.8 186 296.4 319.2 368.4 319.2 308.4 204 246 259.2 100.8 320.4 66 320.4 12 285.6 31.2 294 0 244.8 0ZM199.2 128.4 86.4 186 162 225.6 199.2 128.4ZM158.4 364.8 122.4 460.8 232.8 405.6 158.4 364.8Z"
      fill="white"
      fillRule="evenodd"
      stroke="white"
      strokeWidth="1"
...
const config: DocsThemeConfig = {
  ...
  docsRepositoryBase:
    "https://github.com/famlam-ca/hhn-documentation/blob/main",
  useNextSeoProps() {
    const { asPath } = useRouter()
    if (asPath !== "/") {
      return {
        titleTemplate: "%s - HHN Docs"
      }
    }
  },
  logo,
  head: function useHead() {
    ...
    const socialCard =
      route === "/" || !title
        ? "https://docs.famlam.ca/hhn-docs"
        : `https://docs.famlam.ca/hhn-docs?title=${title}`
    ...
    return (
      <>
        ...
        <meta
          name="description"
          content="The official documentation for the Humble Home Network."
        />
        <meta
          name="og:description"
          content="The official documentation for the Humble Home Network."
        ...
        <meta name="twitter:site:domain" content="docs.famlam.ca" />
        <meta name="twitter:url" content="https://docs.famlam.ca" />
        <meta
          name="og:title"
          content={title ? title + " – HHN Docs" : "HHN Docs"}
        />
        <meta name="og:image" content={socialCard} />
        <meta name="apple-mobile-web-app-title" content="HHN Docs" />
    ...
    text: (
      <div className="flex w-full flex-col items-center sm:items-start">
        ...
        <p className="mt-6 text-xs">
          ...
          <a href="https://www.famlam.ca" target="_blank">
            Humble Home Network
          </a>
          .
        </p>
