...
**_NOTE_**: This guide is not fully tested, and subject to change.
...
### 1. Install Proxmox VE on Each Node

If you require assistance with the installation of Proxmox VE, we have a detailed guide covering the installation process step-by-step [here](/proxmox/proxmox-setup-guide).
...
### 2. Configure Network Time Protocol (NTP) (Optional)
