...
## Notes
1. Depending on your distro of choice <sub><sup>\(I use arch btw\)</sup></sub> you may not be able do anything, or commands may be different, such as many debian-based systems using "apt" and arch-based systems using "pacman".
